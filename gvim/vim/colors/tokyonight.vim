...
\ 'Search': {'fg': colors.bg, 'bg': '#5670a6', 'gui': 'bold'},
...
\ 'Question': 'MoreMsg',
\ 'DiffChange': { 'bg': "#cfd175", 'fg': colors.black },
\ 'DiffText': { 'bg': "#d1a11b", 'fg': colors.black, 'gui': 'bold' },
\ 'DiffAdd': { 'bg': "#a3c9a5", 'fg': colors.black },
\ 'DiffDelete': { 'bg': "#ffabab", 'fg': colors.black },
\ 'DiffAdded': 'DiffAdd',
